...
export class LNR {
  ...
  static get RESOLVER_ADDRESS() {
    return Constants.lnrResolverAddress;
  }

  static get WRAPPER_ADDRESS() {
    return Constants.lnrWrapperAddress;
  }

  static get LINAGEE_ADDRESS() {
    return Constants.lnrAddress;
  }
  ...
  constructor(_ethers, _signer) {
    this.ethers = _ethers;
    this.signer = _signer;
    this.lnrResolverAbi = Constants.lnrResolverAbi;
    this.lnrWrapperAbi = Constants.lnrWrapperAbi;
    this.lnrAbi = Constants.lnrAbi;
    this.resolverContract = new this.ethers.Contract(LNR.RESOLVER_ADDRESS, this.lnrResolverAbi, this.signer);
    this.wrapperContract = new this.ethers.Contract(LNR.WRAPPER_ADDRESS, this.lnrWrapperAbi, this.signer);
    this.linageeContract = new this.ethers.Contract(LNR.LINAGEE_ADDRESS, this.lnrAbi, this.signer);
  }
